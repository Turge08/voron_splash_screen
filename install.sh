...
sudo cp /boot/cmdline.txt /boot/firmware/cmdline.txt.bak
echo "$cmdline quiet vt.global_cursor_default=0 plymouth.ignore-serial-consoles" | sudo tee /boot/firmware/cmdline.txt
